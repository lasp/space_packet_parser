...
""",
            SpacePacket(**{"MSN__PARAM": common.FloatParameter(678, 3)}),
            None,
            True,
        ),
        (
...
""",
            SpacePacket(**{"MSN__PARAM": common.FloatParameter(668, 3)}),
            None,
            False,
        ),
        (
...
""",
            SpacePacket(**{"MSN__PARAM": common.FloatParameter(658, 3)}),
            None,
            True,
        ),
        (
...
<xtce:Comparison xmlns:xtce="{XTCE_1_2_XMLNS}"
    comparisonOperator="&lt;" value="678" parameterRef="MSN__PARAM"/>
""",
            SpacePacket(**{"MSN__PARAM": common.FloatParameter(679, 3)}),
            None,
            False,
        ),
        (
...
""",
            SpacePacket(**{"MSN__PARAM": common.FloatParameter(670, 3)}),
            None,
            True,
        ),
        (
...
<xtce:Comparison xmlns:xtce="{XTCE_1_2_XMLNS}"
    comparisonOperator="&lt;=" value="678" parameterRef="MSN__PARAM"/>
""",
            SpacePacket(**{"MSN__PARAM": common.FloatParameter(660, 3)}),
            None,
            True,
        ),
        (
...
""",
            SpacePacket(**{"MSN__PARAM": common.FloatParameter(690, 3)}),
            None,
            False,
        ),
        (
...
""",
            SpacePacket(**{"MSN__PARAM": common.FloatParameter(690, 678)}),
            None,
            True,
        ),
        (
...
""",
            SpacePacket(**{"MSN__PARAM": common.StrParameter("calibratedfoostring", "foostring")}),
            None,
            True,
        ),
        (
...
""",
            SpacePacket(**{"MSN__PARAM": common.FloatParameter(3.14, 1)}),
            None,
            True,
        ),
        (
...
""",
            {},
            3,
            ComparisonError("Fails to parse a float string 3.0 into an int"),
        ),
    ],
)
@pytest.mark.filterwarnings("ignore:Performing a comparison against a current value")
def test_comparison(
    elmaker, xtce_parser, xml_string, test_parsed_data, current_parsed_value, expected_comparison_result
):
...
""",
            SpacePacket(**{"P1": common.IntParameter(700, 4), "P2": common.IntParameter(678, 3)}),
            True,
        ),
        (
            f"""
...
""",
            SpacePacket(**{"P1": common.StrParameter("abcd"), "P2": common.StrParameter("abcd")}),
            True,
        ),
        (
            f"""
...
""",
            SpacePacket(**{"P1": common.FloatParameter(3.14, 1), "P2": common.FloatParameter(3.14, 180)}),
            True,
        ),
    ],
)
...
@pytest.mark.parametrize(
    ("args", "kwargs", "expected_error", "expected_error_msg"),
    [
        (("X", "~="), {"right_value": "4"}, ValueError, "Unrecognized operator syntax ~="),
        (
            ("X", "=="),
            {"right_param": "R", "right_value": "1"},
            comparisons.ComparisonError,
            "Received both a right_value and a right_param reference to Condition",
        ),
        (
            ("X", "=="),
            {"right_value": "4", "right_use_calibrated_value": True},
            comparisons.ComparisonError,
            "Unable to use calibrated form of a fixed value in Condition",
        ),
    ],
)
...
""",
            SpacePacket(**{"P1": common.IntParameter(678, 1)}),
            10,
        ),
        (
            f"""
...
""",
            SpacePacket(**{"P1": common.IntParameter(678, 0)}),
            None,
        ),
        (
            f"""
