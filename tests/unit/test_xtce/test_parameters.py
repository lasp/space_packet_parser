    ...
    [
        ...
        (
            space_packet_parser.xtce.parameter_types.StringParameterType(
                "TEST_STRING", encodings.StringDataEncoding(fixed_raw_length=24)
            ),
            # This still 123X456
            b"123X456",
            0,
        ...
        (
            space_packet_parser.xtce.parameter_types.StringParameterType(
                ...
                encodings.StringDataEncoding(
                    dynamic_length_reference="STR_LEN",
        ...
        (
            space_packet_parser.xtce.parameter_types.StringParameterType(
                "TEST_STRING",
                encodings.StringDataEncoding(fixed_raw_length=64, encoding="UTF-8", termination_character="58"),
            ),
        ...
        (
            space_packet_parser.xtce.parameter_types.StringParameterType(
                "TEST_STRING",
                encodings.StringDataEncoding(fixed_raw_length=128, encoding="UTF-8", termination_character="58"),
            ),
        ...
        (
            space_packet_parser.xtce.parameter_types.StringParameterType(
                "TEST_STRING",
                encodings.StringDataEncoding(fixed_raw_length=48, encoding="UTF-8", termination_character="58"),
            ),
        ...
        (
            space_packet_parser.xtce.parameter_types.StringParameterType(
                "TEST_STRING",
                encodings.StringDataEncoding(fixed_raw_length=160, encoding="UTF-8", termination_character="00"),
            ),
        ...
        (
            space_packet_parser.xtce.parameter_types.StringParameterType(
                "TEST_STRING",
                encodings.StringDataEncoding(
                    fixed_raw_length=19 * 16, encoding="UTF-16BE", termination_character="0021"
                ),
            ),
        ...
        (
            space_packet_parser.xtce.parameter_types.StringParameterType(
                "TEST_STRING",
                encodings.StringDataEncoding(
                    fixed_raw_length=16 * 6, encoding="UTF-16LE", termination_character="5800"
                ),
            ),
        ...
        (
            space_packet_parser.xtce.parameter_types.StringParameterType(
                "TEST_STRING",
                encodings.StringDataEncoding(
                    fixed_raw_length=16 * 5, encoding="UTF-16BE", termination_character="0058"
                ),
            ),
        ...
        (
            space_packet_parser.xtce.parameter_types.StringParameterType(
                "TEST_STRING", encodings.StringDataEncoding(fixed_raw_length=29, leading_length_size=5)
            ),
...
def test_string_parameter_parsing(parameter_type, binary_data, current_pos, expected_raw, expected_derived):
    ...
    packet = spp.SpacePacket(
        ...
        **{"P1": common.FloatParameter(7.55, 7), "P2": common.IntParameter(100, 99), "STR_LEN": common.IntParameter(8)},
    )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            space_packet_parser.xtce.parameter_types.IntegerParameterType(
                "TEST_INT", encodings.IntegerDataEncoding(16, "unsigned", byte_order="leastSignificantByteFirst")
            ),
            0b1000000000000000.to_bytes(length=2, byteorder="big"),
            0,
            128,
        ...
        (
            space_packet_parser.xtce.parameter_types.IntegerParameterType(
                "TEST_INT", encodings.IntegerDataEncoding(16, "signed", byte_order="leastSignificantByteFirst")
            ),
                    ...
                    context_calibrators=[
                        calibrators.ContextCalibrator(
                            ...
                            calibrators.PolynomialCalibrator(
                                [calibrators.PolynomialCoefficient(5, 0), calibrators.PolynomialCoefficient(2, 1)]
                            ),
                        )
                    ],
                ),
        ...
        (
            space_packet_parser.xtce.parameter_types.IntegerParameterType(
                "TEST_INT", encodings.IntegerDataEncoding(12, "signed", byte_order="leastSignificantByteFirst")
            ),
            # 12-bit signed little endian integer starting on bit 4 of the first byte.
            # The LSB of the integer comes first
        ...
        (
            space_packet_parser.xtce.parameter_types.IntegerParameterType(
                "TEST_INT", encodings.IntegerDataEncoding(3, "twosComplement")
            ),
    ...
    [
        ...
        (
            space_packet_parser.xtce.parameter_types.FloatParameterType(
                "TEST_FLOAT", encodings.FloatDataEncoding(32, byte_order="leastSignificantByteFirst")
            ),
                ...
                encodings.IntegerDataEncoding(
                    ...
                    context_calibrators=[
                        calibrators.ContextCalibrator(
                            ...
                            calibrators.PolynomialCalibrator(
                                [calibrators.PolynomialCoefficient(5.6, 0), calibrators.PolynomialCoefficient(2.1, 1)]
                            ),
                        )
                    ],
                ),
        ...
        (
            space_packet_parser.xtce.parameter_types.FloatParameterType(
                "MIL_1750A_FLOAT", encodings.FloatDataEncoding(32, encoding="MILSTD_1750A")
            ),
            b"\x7f\xff\xff\x7f",
            0.9999998 * (2**127),
        ),
    ...
    [
        (
            space_packet_parser.xtce.parameter_types.EnumeratedParameterType(
                "TEST_ENUM", encodings.IntegerDataEncoding(16, "unsigned"), {32768: "NOMINAL"}
            ),
            0b1000000000000000.to_bytes(length=2, byteorder="big"),
            32768,
            "NOMINAL",
        ...
        (
            space_packet_parser.xtce.parameter_types.EnumeratedParameterType(
                "TEST_FALSY_RAW_ENUM", encodings.IntegerDataEncoding(16, "unsigned"), {0: "FALSY_LABEL"}
            ),
        ...
        (
            space_packet_parser.xtce.parameter_types.EnumeratedParameterType(
                "TEST_NEGATIVE_ENUM", encodings.IntegerDataEncoding(16, "signed"), {-42: "VAL_LOW"}
            ),
            0b1111111111010110.to_bytes(length=2, byteorder="big"),
            -42,
            "VAL_LOW",
        ...
        (
            space_packet_parser.xtce.parameter_types.EnumeratedParameterType(
                ...
                encoding=encodings.FloatDataEncoding(
                    size_in_bits=32, encoding="IEEE754", byte_order="mostSignificantByteFirst"
                ),
                # NOTE: Duplicate final value is on purpose to make sure we handle that case
                enumeration={0.0: "BOOT_POR", 3.5: "BOOT_RETURN", 2.2: "OP_LOW", 3.3: "OP_HIGH", 4.4: "OP_HIGH"},
            ),
    ...
    [
        ...
        (
            space_packet_parser.xtce.parameter_types.BinaryParameterType(
                "TEST_BIN", encodings.BinaryDataEncoding(fixed_size_in_bits=16)
            ),
        ...
        (
            space_packet_parser.xtce.parameter_types.BinaryParameterType(
                "TEST_BIN",
                encodings.BinaryDataEncoding(
                    size_reference_parameter="BIN_LEN", use_calibrated_value=False, linear_adjuster=lambda x: 8 * x
                ),
            ),
            0b0011010000110010010100110000000001001011000000000100100100000000.to_bytes(length=8, byteorder="big"),
            b"42",
...
def test_binary_parameter_parsing(parameter_type, binary_data, expected):
    ...
    # pre parsed data to reference for lookups
    packet = spp.SpacePacket(
        binary_data=binary_data, **{"P1": common.FloatParameter(7.4, 1), "BIN_LEN": common.IntParameter(2)}
    )
    value = parameter_type.parse_value(packet)
    assert value == expected
    ...
    [
        (
            space_packet_parser.xtce.parameter_types.BooleanParameterType(
                "TEST_BOOL", encodings.BinaryDataEncoding(fixed_size_in_bits=1)
            ),
        ...
        (
            space_packet_parser.xtce.parameter_types.BooleanParameterType(
                "TEST_BOOL", encodings.StringDataEncoding(fixed_raw_length=120, encoding="UTF-8")
            ),
        ...
        (
            space_packet_parser.xtce.parameter_types.BooleanParameterType(
                "TEST_BOOL", encodings.IntegerDataEncoding(size_in_bits=2, encoding="unsigned")
            ),
        ...
        (
            space_packet_parser.xtce.parameter_types.BooleanParameterType(
                "TEST_BOOL", encodings.FloatDataEncoding(size_in_bits=16)
            ),
    ...
    [
        ...
        (
            space_packet_parser.xtce.parameter_types.AbsoluteTimeParameterType(
                ...
                epoch="2009-10-10T12:00:00-05:00",
                offset_from="MilliSeconds",
            ),
            # Exactly 64 bits so neatly goes into a bytes object without padding
            0b0011010000110010010100110000000001001011000000000100100100000000.to_bytes(length=8, byteorder="big"),
...
def test_parameter(elmaker, xtce_parser, param_xml, param_object):
    """Test Parameter"""
    assert ElementTree.tostring(param_object.to_xml(elmaker=elmaker), pretty_print=True) == ElementTree.tostring(
        ElementTree.fromstring(param_xml, parser=xtce_parser), pretty_print=True
    )
