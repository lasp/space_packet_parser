...
class SequenceContainer(common.Parseable, common.XmlObject):
    ...
    name: str
    entry_list: list[Union[ParameterRefEntry, parameters.Parameter, "SequenceContainer"]]
    ...
    _parameter_lookup: Optional[dict[str, parameters.Parameter]] = field(default=None, repr=False, compare=False)
